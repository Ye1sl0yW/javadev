...
public class AnnoncesignalController implements Initializable {
 ...
 try {
            ...
            message.setFrom(new InternetAddress("hamdi.gtari@esprit.tn"));
            message.setRecipients(
                    Message.RecipientType.TO,
                    InternetAddress.parse("hamdi.gtari@esprit.tn")
            );
            message.setSubject("A propos des Annonces Signalés");
            message.setText("Le nombre de signal de la date est plus que 5, veuillez consulter la page de "
                    + "statistique,"
                    + "\n\n Merci");
