...
public class PortfoliosController implements Initializable {
    ...
    private void setSearchCol(ActionEvent event) {
         switch(((MenuItem) event.getSource()).getId()){
            case "search_col_uid": searchcol="user_id";search_col.setText("User"); search_input.setVisible(true);montant_choix.setVisible(false); break;
            case "search_col_m": searchcol="montant";search_col.setText("Montant");search_input.setVisible(false); montant_choix.setVisible(true); break;
...
new Alert(Alert.AlertType.ERROR, s).showAndWait();  
    ...
    private void chercherparmontant(ActionEvent event) {
        ResultSet r = null;
            ...
            r=Interaction_Portfolios.getPortfoliosByMontant(Integer.valueOf(montant_debut.getText()), Integer.valueOf(montant_fin.getText()));
