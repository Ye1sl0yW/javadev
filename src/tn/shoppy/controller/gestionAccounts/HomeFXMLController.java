...
import tn.shoppy.utils.gestionAccounts.data;
 ...
 @FXML
    ...
    private void handleButtonAction(MouseEvent event) throws IOException {
        if (event.getTarget() == btn_profile) {
            AnchorPane p = FXMLLoader.load(getClass().getResource("/tn/shoppy/view/gestionAccounts/SocialFXML.fxml"));
            ...
            AnchorPane p = FXMLLoader.load(getClass().getResource("/tn/shoppy/view/gestionAccounts/AjoutPanier.fxml"));
            ...
            AnchorPane p = FXMLLoader.load(getClass().getResource("/tn/shoppy/view/gestionAccounts/AnnonceAffFXML.fxml"));
            ...
            AnchorPane p = FXMLLoader.load(getClass().getResource("/tn/shoppy/view/gestionAccounts/ListeWork.fxml"));
            ...
            AnchorPane p = FXMLLoader.load(getClass().getResource("/tn/shoppy/view/gestionAccounts/Acceuil.fxml"));
            ...
            AnchorPane p = FXMLLoader.load(getClass().getResource("/tn/shoppy/view/gestionAccounts/MoncompteFXML.fxml"));
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        try {
            pa = FXMLLoader.load(getClass().getResource("/tn/shoppy/view/gestionAccounts/AnnonceAffFXML.fxml"));
