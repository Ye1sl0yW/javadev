...
@FXML
    void signabtnaction(ActionEvent e) throws IOException {
        ...
        AnchorPane p = FXMLLoader.load(getClass().getResource("/tn/shoppy/view/gestionAccounts/Annoncesignal.fxml"));
...
void gotoAd(ActionEvent e) throws IOException {
        ...
        AnchorPane p = FXMLLoader.load(getClass().getResource("/tn/shoppy/view/gestionAccounts/AfficheBackFXML.fxml"));
        this.anchv.getChildren().setAll(p);
