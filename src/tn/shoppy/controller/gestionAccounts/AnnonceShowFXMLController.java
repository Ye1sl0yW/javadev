...
protected GoogleMapView mapComponent;
    ...
    public void showEv() {
        ...
        //affichage image 
        ImageView photo = new ImageView(new Image("http://localhost/shoppyBlog/web/uploads/annonce/" + evs.getPhoto()));
...
//        p.setFill(Color.AQUAMARINE);
       ...
       des.setText(evs.getDescription());
        ...
        Image im =new Image("http://localhost/shoppyBlog/web/uploads/annonce/"+evs.getPhoto());
                                imge.setImage(im);
        ...
        list.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                FXMLLoader root = new FXMLLoader(getClass().getResource("/tn/shoppy/view/gestionAccounts/AnnonceAffFXML.fxml"));
                try {
