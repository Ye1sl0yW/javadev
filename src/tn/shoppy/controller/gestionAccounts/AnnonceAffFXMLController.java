...
import tn.shoppy.model.gestionAccounts.Annonce;
import tn.shoppy.model.gestionAccounts.FosUser;
import tn.shoppy.services.gestionAccounts.AnnonceServices;
...
public class AnnonceAffFXMLController implements Initializable, MapComponentInitializedListener, DirectionsServiceCallback {
    ...
    ObservableList<String> typel = FXCollections.observableArrayList("electro", "maison","corona", "autres", "vide");
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        for (Annonce evv : le) {
            ...
            ImageView photo = new ImageView(new Image("http://localhost/shoppyBlog/web/uploads/annonce/" + evv.getPhoto()));
  ...
  btfb.setOnAction(new EventHandler<ActionEvent>() {
          ...
          //  Annonce loc = ls.afficherLocalUn(Annonce.getId());
            ...
            bt.setOnAction(new EventHandler<ActionEvent>() {
                ...
                public void handle(ActionEvent event) {
                    ...
                    try {
                        ...
                        loader.setLocation(getClass().getResource("/tn/shoppy/view/gestionAccounts/AnnonceShowFXML.fxml"));
            ...
            bt2.setOnAction(new EventHandler<ActionEvent>() {
                ...
                public void handle(ActionEvent event) {
                    try {
                        FXMLLoader root = new FXMLLoader(getClass().getResource("/tn/shoppy/view/gestionAccounts/UpdateAnnonceFXML.fxml"));
...
//                es.afficherev();
               GoogleMapView mapView = new GoogleMapView();
                ...
                ImageView photo = new ImageView(new Image("http://localhost/shoppyBlog/web/uploads/annonce/" + evv.getPhoto()));
                System.out.println("http://localhost/shoppyBlog/web/uploads/annonce/" + evv.getPhoto());
                photo.setFitHeight(200);
                photo.setFitWidth(200);
...
/////////////////////////////BUTTONS///////////////////////////////////////////////////////////////
 ...
 if (evv.getIdUser() == f.getId()) {
    ...
    void goToAj(ActionEvent e) throws IOException {
        ...
        AnchorPane lp = FXMLLoader.load(getClass().getResource("/tn/shoppy/view/gestionAccounts/AnnonceAddFXML.fxml"));
